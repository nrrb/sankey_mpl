...
[![Python](https://img.shields.io/python/required-version-toml?tomlFilePath=https://raw.githubusercontent.com/nrrb/sankey_mpl/main/pyproject.toml)](https://github.com/nrrb/sankey_mpl/blob/main/pyproject.toml)
[![Ruff](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/astral-sh/ruff/main/assets/badge/v2.json)](https://github.com/astral-sh/ruff)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/nrrb/sankey_mpl/blob/main/LICENSE)

<!--
Deliberately not a downloads badge. The shields endpoint for it answers "rate limited
by upstream service" often enough to look broken, and monthly downloads on a package
this young measure nothing.

The distribution name is `sankey-mpl`: PEP 503 normalises the underscore in
`name = "sankey_mpl"` to a hyphen, so that is what the index serves it under, which
is why the badge above uses the hyphen while the import stays underscored.
-->

Sankey diagrams for matplotlib, as clean vector output.

![86,400 Seconds in the Life of a Cat](https://raw.githubusercontent.com/nrrb/sankey_mpl/main/examples/catday.png)
...
- **Two entry points.** `render_sankey` builds and owns a figure; `draw_sankey(ax, ...)`
  draws into an axes you already have, so a sankey can sit in a `plt.subplots` grid
  beside other plots. Both resolve identical geometry, and `build_frame` reports the
  final pixel size before anything is drawn.
...
**[The Sourdough Dynasty](https://github.com/nrrb/sankey_mpl/blob/main/examples/sourdough.svg)**: flows that split and rejoin.
...
![The Sourdough Dynasty](https://raw.githubusercontent.com/nrrb/sankey_mpl/main/examples/sourdough.png)

**[Break Room Forensics](https://github.com/nrrb/sankey_mpl/blob/main/examples/breakroom.svg)**: six columns and dense sharing,
...
![Break Room Forensics](https://raw.githubusercontent.com/nrrb/sankey_mpl/main/examples/breakroom.png)

**[The Group Chat Decides Where to Get Brunch](https://github.com/nrrb/sankey_mpl/blob/main/examples/groupchat.svg)**: a pure
...
![It Was DNS](https://raw.githubusercontent.com/nrrb/sankey_mpl/main/examples/itwasdns.png)
...
**[docs/usage.md](https://github.com/nrrb/sankey_mpl/blob/main/docs/usage.md)** is the full usage spec: the data model, every
...
[docs/usage.md](https://github.com/nrrb/sankey_mpl/blob/main/docs/usage.md#differences-from-chartjs-chart-sankey). See
[NOTICE](https://github.com/nrrb/sankey_mpl/blob/main/NOTICE) for the upstream copyright.

`UPSTREAM_VERSION` records which upstream release the geometry tracks.

## Development

**[CONTRIBUTING.md](https://github.com/nrrb/sankey_mpl/blob/main/CONTRIBUTING.md)**
covers what a change here has to respect, including several things in `layout.py` that
look like mistakes and are not.

The four checks CI runs, all of which must pass:
